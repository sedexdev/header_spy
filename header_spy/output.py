...
def uni_file_heading(header: str, subdomain: str, single=True) -> None:
    """
...
def verbose_write_file(secure_headers: List) -> None:
    """
    Write verbose output about the implications of
    each missing security header to stdout
...
def write_file(headers: HTTPMessage, subdomain: str, verbose: bool) -> None:
    """
    ...
    with open(OUTPUT_FILE_PATH, 'a') as file:
        ...
        if len(secure_headers):
            ...
            file.write("=================================================="
                       "=============================================\n\n")
    if verbose:
        verbose_write_file(secure_headers)
